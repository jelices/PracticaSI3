...
<table>
<tr>
<td> <input type="submit" value="Modificar Informacion de Empresa" onClick="copiar('editarPerfil')" /> </td>
<td> <input type="submit" value="Modificar Recepcion de Informes" onClick="copiar('cambiarInformes')" /> </td>
</tr>
</table>
</form>
<% }%>
