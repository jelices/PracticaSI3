...
<p><br></p>
<p><br></p>
<form  method="POST" action="registro2.do">
<table width="70%" align="center">
	...
	<tr>
		...
		<td> <textarea name="sedeSocial" rows="4" cols="30"></textarea></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td> <input type="text" name="nombreContacto"/> </td>
	</tr>
	<tr>
		<td align="right"> Apellidos </td>
		<td> <input type="text" name="apellidosContacto"/> </td>
	</tr>
	<tr><td><br></td></tr>
	<tr>
	...
	<tr>
		...
		<td> 
			<select name="subcategoriaS" id="subcategoriaS" onChange="copiar()" onFocus="Combos(document.getElementById('tipoActividadS'))">
				<option value="01">01.- Agricultura, ganader&iacute;a, caza y servicios relacionados con las mismas</option>
				<option value="02">02.- Silvicultura y explotaci&oacute;n forestal</option>
				<option value="03">03.- Pesca y acuicultura</option>
			</select>
		</td>
		<input type="hidden" name="categoriaEmpresa" id="categoriaEmpresa" />
