...
<p><br></p>
<p><br></p>
<form  method="POST" name="form" action="registro3.do">
<table>
	<tr>
...
<table>
	...
	<tr>
		<td> <input type="hidden" name="informe" id="informe"></td>
		<td> <input type="hidden" name="formato" id="formato"></td>
		<td> <input type="hidden" name="catSubvenciones" id="catSubvenciones"></td>
	</tr>
	<tr>
		<td></td>
	</tr>
